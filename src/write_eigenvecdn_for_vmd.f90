subroutine write_igenvecdn_for_vmd(Eigen_vec)
use kind_param
use global_var
implicit none
integer::i,j,k,state
...
if (NUMEMAX>=1)then
open(9,file='../output_for_vmd/1st6_eigen_vecdn.dat')
do i=1,hamilton_dim
write(9,300) (volume*Eigen_vec(i+j*hamilton_dim),j=0,5)
enddo
endif
if (NUMEMAX>6)then
open(10,file='../output_for_vmd/7to12_eigen_vecdn.dat')
do i=1,hamilton_dim
write(10,300) (volume*Eigen_vec(i+j*hamilton_dim),j=6,11)
enddo
endif
if (NUMEMAX>12)then
open(11,file='../output_for_vmd/13to18_eigen_vecdn.dat')
do i=1,hamilton_dim
write(11,300) (volume*Eigen_vec(i+j*hamilton_dim),j=12,17)
enddo
endif
if (NUMEMAX>17)then
open(12,file='../output_for_vmd/19to24_eigen_vecdn.dat')
do i=1,hamilton_dim
write(12,300) (volume*Eigen_vec(i+j*hamilton_dim),j=18,23)
enddo
endif
if (NUMEMAX>24)then
open(13,file='../output_for_vmd/25to30_eigen_vecdn.dat')
do i=1,hamilton_dim
...
RETURN
end subroutine write_igenvecdn_for_vmd
